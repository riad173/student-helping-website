...
if(isset($_POST['delete_video'])){
   ...
   $delete_video = $conn->prepare("SELECT video FROM `video_upload` WHERE id = ? LIMIT 1");
...
<section class="view-content">
   ...
   <?php
      $select_content = $conn->prepare("SELECT * FROM `video_upload` WHERE id = ? AND tutor_id = ?");
   ...
   ?>
   <div class="container">
      <video src="../uploaded_files/video/<?= $fetch_content['video']; ?>" autoplay controls poster="../uploaded_files/video/<?= $fetch_content['thumb']; ?>" class="video"></video>
...
<section class="comments">
   ...
   <div class="show-comments">
      ...
      <div class="box">
         <div class="user">
            <img src="../uploaded_files/video/<?= $fetch_commentor['image']; ?>" alt="">
            <div>
